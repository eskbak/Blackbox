...
void setup() {                                  //sier seg selv
  ...
  mpu.begin();
  mpu.calcOffsets(true, true); //imu og acc

  ubidots.add(crash_alarm, 0);
